...
const bakeryHighlights = [
  ...
  {
    icon: <HeartHandshake className="w-6 h-6 text-amber-600 dark:text-amber-400" />,
...
export default function CakeShop() {
  ...
  return (
    <div className="bg-amber-50/60 dark:bg-stone-950 text-stone-800 dark:text-stone-100 font-sans overflow-x-hidden transition-colors duration-300">
      ...
      <section className="min-h-screen flex flex-col justify-center px-6 max-w-7xl mx-auto py-12 relative">
        <div className="grid md:grid-cols-2 items-center gap-12">
          ...
          <div className="space-y-6">
            <span className="inline-flex items-center gap-2 bg-pink-100 dark:bg-pink-900/50 text-pink-700 dark:text-pink-300 px-4 py-1.5 rounded-full text-xs md:text-sm font-semibold tracking-wide border border-pink-200 dark:border-pink-800">
              <Home className="w-4 h-4 text-pink-600 dark:text-pink-400" />
              100% Home Baked Fresh Daily
            </span>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold text-stone-900 dark:text-stone-50 leading-tight">
              Flavors Crafted With Heart &amp; Passion.
            </h1>
            <p className="text-base md:text-lg text-stone-600 dark:text-stone-300 max-w-md">
              Welcome to <span className="font-semibold text-pink-600 dark:text-pink-400">Butterfly Bakes</span>. A home kitchen turned dream, crafting delicious custom cakes for every occasion.
            </p>
            ...
            <Link href="/menu">
              <div className="pt-4">
                <motion.button
                  ...
                  className="bg-pink-600 hover:bg-pink-700 dark:bg-pink-500 dark:hover:bg-pink-600 text-white font-medium px-8 py-4 rounded-full shadow-lg flex items-center gap-2 text-base cursor-pointer"
                >
          ...
          <div className="flex justify-center">
            <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full p-2 bg-gradient-to-tr from-amber-200 via-pink-300 to-amber-400 dark:from-amber-600 dark:via-pink-600 dark:to-amber-500 shadow-2xl">
              
              <motion.div
                animate={{ rotate: 360 }}
                transition={{ repeat: Infinity, duration: 25, ease: "linear" }}
                className="w-full h-full rounded-full overflow-hidden border-4 border-white dark:border-stone-800 shadow-inner"
              >
                <img
      ...
      {/* PAGE 2: OCCASIONS */}
      <section
        ref={(node: HTMLDivElement | null) => setSection2Element(node)}
        className="min-h-screen py-20 px-6 max-w-7xl mx-auto border-t border-amber-200/50 dark:border-stone-800 flex flex-col justify-center relative overflow-hidden"
      >
        <motion.div
        ...
        <div className="text-center mb-14">
          <span className="text-pink-600 dark:text-pink-400 font-medium tracking-widest uppercase text-xs md:text-sm">For Every Celebration</span>
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-stone-900 dark:text-stone-50 mt-2">What Are You Ordering For?</h2>
          <p className="text-stone-600 dark:text-stone-300 mt-2 text-sm md:text-base">Custom home-baked cakes handcrafted for every special event.</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {occasions.map((item, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white dark:bg-stone-900 p-5 rounded-3xl shadow-sm border border-stone-200/60 dark:border-stone-800 hover:shadow-xl transition-all"
            >
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-lg font-serif font-bold text-stone-900 dark:text-stone-100">{item.title}</h3>
              </div>
              <p className="text-stone-600 dark:text-stone-400 text-xs md:text-sm leading-relaxed">{item.desc}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      {/* PAGE 3: HIGHLIGHTS */}
      <section className="min-h-screen py-20 px-6 max-w-7xl mx-auto border-t border-amber-200/50 dark:border-stone-800 flex flex-col justify-center relative">
        <div className="text-center mb-14">
          <span className="text-pink-600 dark:text-pink-400 font-medium tracking-widest uppercase text-xs md:text-sm">
            Crafted For You
          </span>
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-stone-900 dark:text-stone-50 mt-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center max-w-4xl mx-auto relative">
          ...
          {bakeryHighlights.map((item, idx) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white/90 dark:bg-stone-900/90 backdrop-blur-sm p-6 rounded-3xl shadow-sm hover:shadow-md border border-stone-200/60 dark:border-stone-800 flex items-start gap-4 z-10 transition-all group"
            >
              <div className={`p-3.5 rounded-2xl ${item.bg} group-hover:scale-110 transition-transform shrink-0`}>
                {item.icon}
              </div>
              <div className="space-y-1">
                <h4 className="font-serif font-bold text-stone-900 dark:text-stone-100 text-base md:text-lg">
                  {item.title}
                </h4>
